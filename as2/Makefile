...
ifeq ($(shell sw_vers 2>/dev/null | grep Mac | awk '{ print $$2}'),Mac)
	CFLAGS = -g -DGL_GLEXT_PROTOTYPES -I./include/ -I/opt/X11/include -DOSX -Ieigen/
...
main: raytracer.o Util.o
	$(CC) $(CFLAGS) -o raytracer raytracer.o Util.o $(LDFLAGS) -O2 -lm -L/opt/X11/lib -lm -lpthread -lX11 -I/usr/X11R6/include
raytracer.o: raytracer.cpp Util.h
	$(CC) $(CFLAGS) -c raytracer.cpp -o raytracer.o -O2 -I/usr/X11R6/include
